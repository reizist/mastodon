...
ActiveRecord::Schema.define(version: 20170520145338) do
  ...
  create_table "statuses", id: :bigint, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.string "uri"
    t.integer "account_id", null: false
    t.text "text"
    t.datetime "created_at", null: false
  ...
  create_table "users", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.string "filtered_languages", default: "0", null: false
